#!/bin/bash
#SBATCH --job-name=archs4_study_cov_10
#SBATCH --output=log_ARCHS4_study_coverage_10.%j.log
#SBATCH --error=log_ARCHS4_study_coverage_10.%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --mem=100GB
...
jupyter nbconvert --to notebook --execute \
  nbs/01_model_building/04_archs4/07_bp_coverage_study/02_bp_coverage_study_10.ipynb \
  --output 02_bp_coverage_study_10_executed.ipynb
end=$(date +%s)
