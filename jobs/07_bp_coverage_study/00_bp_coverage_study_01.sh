#!/bin/bash
#SBATCH --job-name=archs4_study_cov_01
#SBATCH --output=log_ARCHS4_study_coverage_01.%j.log
#SBATCH --error=log_ARCHS4_study_coverage_01.%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --mem=100GB
...
jupyter nbconvert --to notebook --execute \
  nbs/01_model_building/04_archs4/07_bp_coverage_study/00_bp_coverage_study_01.ipynb \
  --output 00_bp_coverage_study_01_executed.ipynb
end=$(date +%s)
