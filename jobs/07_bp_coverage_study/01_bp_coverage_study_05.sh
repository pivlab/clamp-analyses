#!/bin/bash
#SBATCH --job-name=archs4_study_cov_05
#SBATCH --output=log_ARCHS4_study_coverage_05.%j.log
#SBATCH --error=log_ARCHS4_study_coverage_05.%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=16
#SBATCH --mem=100GB
...
jupyter nbconvert --to notebook --execute \
  nbs/01_model_building/04_archs4/07_bp_coverage_study/01_bp_coverage_study_05.ipynb \
  --output 01_bp_coverage_study_05_executed.ipynb
end=$(date +%s)
