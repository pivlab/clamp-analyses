...
# Validates a published GO:BP model and writes its validation record
...
# Converts a Slurm memory value to kilobytes.
...
# Reads Slurm accounting data when it is available.
...
# Checks model files, dimensions, and provenance.
def main() -> None:
