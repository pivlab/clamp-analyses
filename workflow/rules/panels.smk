...
rule fig2_panel:
    input:
        ...
        loadings=rules.hard_pair_loadings_pseudobulk.output.panel_ready,
        loading_stats=rules.hard_pair_loadings_pseudobulk.output.stats,
        multitissue=rules.multitissue_xcell_recovery_gtex.output.panel_ready,
...
rule supp2_panel:
    input:
        orthogonality=rules.geneset_orthogonality_gtex.output.per_term,
