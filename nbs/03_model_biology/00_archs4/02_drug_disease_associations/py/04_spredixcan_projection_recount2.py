...
# # Description
#
# Projects S-PrediXcan MASHR gene-trait z-scores (49 tissues) into the recount2 CLAMP latent space.
#
# **Input**: raw S-PrediXcan pkl files from `00_spredixcan_projection_archs4`.
#
# **Output**: `04_spredixcan_projection_recount2/spredixcan/{stem}-projection-recount2.pkl` (LVs × traits per tissue).
#
...
# Output
OUTPUT_DIR = here('output/03_model_biology/00_archs4/02_drug_disease_associations/04_spredixcan_projection_recount2')
